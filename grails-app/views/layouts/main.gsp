		...
		<nav class="navbar navbar-default" role="navigation" style="position:fixed;top:0;left:0;z-index:99999;width:100%">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/loginpatronus">Patronus</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="dropdown bienes">
							<a href="/loginpatronus/bien/index" class="dropdown-toggle" data-toggle="dropdown">Bienes <span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a class="list" href="/loginpatronus/bien/index">Listado</a></li>
								<li><a class="new" href="/loginpatronus/bien/create">Cargar</a></li>
							</ul>
						</li>
						<li class="dropdown usuarios">
							<a href="/loginpatronus/usuario/index" class="dropdown-toggle" data-toggle="dropdown">Usuarios <span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a class="list" href="/loginpatronus/usuario/index">Listado</a></li>
								<li><a class="new" href="/loginpatronus/usuario/create">Cargar</a></li>
							</ul>
						</li>
					</ul>
